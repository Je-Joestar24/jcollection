    ...
    return (
        <div className={`space-y-8 transform transition-all duration-1000 ${isVisible ? 'translate-x-0 opacity-100' : '-translate-x-20 opacity-0'}`}>
            ...
            <p className="text-lg text-textMuted leading-relaxed max-w-lg">
                Discover a wide range of products, search for your favorites, and save them for later.
                JCollection is your personal product catalog—making it easy to find, organize, and revisit the items you love.
            </p>
            ...
            <div className="grid grid-cols-3 gap-6 pt-8">
                <div className="text-center">
                    <div className="text-3xl font-bold text-primary animate-count-up">50+</div>
                    <div className="text-sm text-textMuted">Products</div>
                </div>
                <div className="text-center">
                    <div className="text-3xl font-bold text-secondary animate-count-up delay-200">--</div>
                    <div className="text-sm text-textMuted">Categories</div>
                </div>
                <div className="text-center">
                    <div className="text-3xl font-bold text-accent animate-count-up delay-400">--</div>
                    <div className="text-sm text-textMuted">Saved Items</div>
                </div>
            </div>
        </div>
    )
